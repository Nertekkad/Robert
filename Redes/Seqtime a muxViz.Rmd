...
length(V(sparcc_g)); length(V(sparcc_g2))
...
plot_multiplex3D(g.list, layer.layout=lay, layer.colors=c("red", "blue"),
                         ...
                         show.aggregate=T)
```
Se requiere fucionar las matrices de adyacencia en una única matriz de supradyacencia característica de una red temporal.
```{r}
library(igraph)
as_adjacency_matrix(graph = g.list[[1]], type = "both",
  attr = NULL, edges = FALSE, names = TRUE,
  sparse = igraph_opt("sparsematrices"))
as_adjacency_matrix(graph = g.list[[2]], type = "both",
  attr = NULL, edges = FALSE, names = TRUE,
  sparse = igraph_opt("sparsematrices"))
```
